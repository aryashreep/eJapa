...
function startJapa(){
    ...
    if(108 == iBeads)
    {
        ...
        document.getElementById("beadsButton").innerHTML = '<span id="beads" style="display: none;"></span><img src="./assets/images/panchatatva_mantra.png" width="180" height="180" id="panchatatva" alt="Panchatatva Mantra" />';
